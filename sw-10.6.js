const CACHE='pilotlog-v10.6-core-v1';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-10.6.css',self.location).href,new URL('./pilotlog-10.6.js',self.location).href,new URL('./manifest.webmanifest',self.location).href,new URL('./nexa-apple-touch-icon-180.png',self.location).href,new URL('./nexa-icon-192.png',self.location).href,new URL('./nexa-icon-512.png',self.location).href];
