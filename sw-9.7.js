const CACHE='pilotlog-v9.7';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-9.7.css',self.location).href,new URL('./pilotlog-9.7.js',self.location).href,new URL('./manifest.webmanifest',self.location).href];
