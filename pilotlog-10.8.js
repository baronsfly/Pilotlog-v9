...
document.addEventListener('DOMContentLoaded',async()=>{
  ...
  if('serviceWorker' in navigator){navigator.serviceWorker.register('./sw-10.8.js').catch(err=>console.warn('Offline cache unavailable',err));}
