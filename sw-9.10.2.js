const CACHE='pilotlog-v9.10.2-sim-ui-clean';
const ROOT=new URL('./',self.location).href;
const INDEX=new URL('./index.html',self.location).href;
const CORE=[ROOT,INDEX,new URL('./pilotlog-9.10.2.css',self.location).href,new URL('./pilotlog-9.10.2.js',self.location).href,new URL('./manifest.webmanifest',self.location).href,new URL('./nexa-apple-touch-icon-180.png',self.location).href,new URL('./nexa-icon-192.png',self.location).href,new URL('./nexa-icon-512.png',self.location).href];
