...
function rosterPlanningEntriesForMonth(month){
  return(operationalDatabase?.records||[])
    ...
    .map(r=>isFlight(r)&&r.rosterVisible?{...r,onDuty:'',offDuty:'',_payrollRosterSynthetic:true,_trainingAuthoritative:!!r.entryVisible}:{...r,_payrollRosterSynthetic:false,_trainingAuthoritative:!!r.entryVisible})
...
const PilotLogEngine=Object.freeze({
  ...
  payroll:month=>payrollData(month),
